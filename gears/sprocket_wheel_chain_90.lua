...
local _shaft_types = {front="gear3d_small_wood",back="gear3d_small_wood",top="gear3d_chain",right="gear3d_chain"}
...
gear3d.register_machine("gear3d:sprocket_wheel_wood_chain_90",
  {
    -- machine def
	  node_description = S("Wood Sprocket Wheel Chain 90"),
