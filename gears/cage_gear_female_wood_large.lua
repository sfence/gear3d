...
local _shaft_types = {front="gear3d_small_wood",back="gear3d_small_wood",top="gear3d_cage_female_large",bottom="gear3d_cage_female_large",right="gear3d_cage_female_large",left="gear3d_cage_female_large"}
...
local function cage_find_side_shafts(shafts, need_rpm_update, top_data, side_data)
  if side_data.shaft_type=="gear3d_cage_female_large" then
    -- special side code
    ...
    for _,side2 in pairs({"front","back"}) do
      ...
      local side_side = appliances.is_connected_to(side_pos, side_node, side_data.side_pos, side_def._shaft_sides)
...
gear3d.register_machine("gear3d:cage_gear_female_wood_large",
  {
    -- machine def
	  node_description = S("Wood Large Female Cage Gear"),
    ...
    -- inactive node def
    tiles = {
      "gear3d_cage_female_large_fwd.png^[verticalframe:24:0",
    },
  },{
    -- active node def
    tiles = {
      {
        image = "gear3d_cage_female_large_fwd.png",
        animation = {
    ...
    tiles = {
      {
        image = "gear3d_cage_female_large_rev.png",
        animation = {
          type = "vertical_frames",
          aspect_w = 264,
          aspect_h = 16,
    ...
    -- broken node def
    description = S("Broken Wood Large Female Cage Gear"),
    drawtype = "mesh",
    mesh = "gear3d_cage_female_large.obj",
    selectionbox = {-0.5, -0.5, -0.25, 0.5, 0.5, 0.25},
    tiles = "gear3d_cage_female_large_fwd.png^[verticalframe:24:1",
  })
